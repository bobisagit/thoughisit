// Stripe webhook: the ONLY writer of paid bids in the ledger.
...
//
// Crown-change emails are handled by the notify_crown_change database
// trigger on the bids table (migration 0007), so they fire identically
// for free-season and paid bids — no email logic here.
//
